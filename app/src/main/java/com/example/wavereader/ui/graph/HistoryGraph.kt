...
* TODO: Fix X axis labels for summary graphs and mini card graphs
 */
@Composable
fun HistoryGraph(waveData: List<MeasuredWaveData>, isInteractive: Boolean = false) {
    ...
    Graph(lines, timeLabels, isInteractive = isInteractive)
}
