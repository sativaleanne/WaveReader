    ...
    suspend fun fetchHistoryRecords(
        ...
        return try {
            ...
            snapshot.mapNotNull { document ->
                ...
                if (locationQuery.isNotBlank() && !location.contains(locationQuery, ignoreCase = true)) return@mapNotNull null
                ...
                val formattedTimestamp = SimpleDateFormat("MMM dd, yyyy HH:mm", Locale.getDefault()).format(
